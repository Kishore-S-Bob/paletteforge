...
export const ColorControls = ({ initialColor }: { initialColor: string }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-4 mb-12 bg-white p-4 rounded-2xl shadow-sm border border-brand-slate-200">
      <div className="flex items-center gap-3 w-full md:w-auto">
        ...
        <div className="relative flex-grow md:w-32">
          <span className="absolute left-3 top-1/2 -translate-y-1/2 text-brand-slate-400 font-mono text-sm">#</span>
          <input 
            type="text" 
            value={color.replace("#", "")} 
